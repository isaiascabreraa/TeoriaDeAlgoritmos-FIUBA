...
def bt_submarinos(matriz, submarinos, celdas_iluminadas, faros_activados):
    if not submarinos:
    ...
    if mejor_faro:
        ...
        nuevos_submarinos = submarinos - celdas_iluminadas  # Elimina las celdas iluminadas
        return bt_submarinos(matriz, nuevos_submarinos, celdas_iluminadas, faros_activados)
...
def submarinos(matriz):
    ...
    return bt_submarinos(matriz, submarinos, celdas_iluminadas, faros_activados)
