...
def contar_ordenamientos_bt(grafo, orden_actual, visitados, orden_total, vertices):
    ...
    for v in vertices:
        ...
        #El vertice V solo se agrega si aun no fue visitado y si todos sus predecesores ya fueron agregados al orden.
            ...
            contar_ordenamientos_bt(grafo, orden_actual, visitados, orden_total, vertices)
