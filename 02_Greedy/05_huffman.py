...
Este algoritmo es greedy? Si y mi regla es "Los caracteres que menos frecuencia acumulen costaran un caracter mas". El codigo de huffman da siempre la manera mas optima de 
